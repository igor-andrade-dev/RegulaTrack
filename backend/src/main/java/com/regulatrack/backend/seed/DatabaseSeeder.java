    ...
    public ApplicationRunner seedDatabase(
        ...
        return args -> {
            ...
            if (userRepository.count() > 0) {
                userRepository.findByUsername("admin").ifPresent(u -> { if (u.getEmail() == null) { u.setEmail("admin@example.com"); userRepository.save(u); } });
                userRepository.findByUsername("user").ifPresent(u -> { if (u.getEmail() == null) { u.setEmail("user@example.com"); userRepository.save(u); } });
            }
            ...
            if (userRepository.count() == 0) {
                ...
                user.setPermissions(EnumSet.of(
                        ...
                        Permission.LICENSES_VIEW, Permission.LICENSES_CREATE, Permission.LICENSES_UPDATE,
                        Permission.COMPANIES_VIEW, Permission.COMPANIES_CREATE, Permission.COMPANIES_UPDATE,
                        Permission.BRANCHES_VIEW, Permission.BRANCHES_CREATE, Permission.BRANCHES_UPDATE
                ));
