...
@org.springframework.security.access.prepost.PreAuthorize("hasAuthority('PERM_BRANCHES_VIEW')")
public class BranchController {

    private final BranchService branchService;

    @PostMapping
    @org.springframework.security.access.prepost.PreAuthorize("hasAuthority('PERM_BRANCHES_CREATE')")
    ...
    @PutMapping("/{id}")
    @org.springframework.security.access.prepost.PreAuthorize("hasAuthority('PERM_BRANCHES_UPDATE')")
    ...
    @DeleteMapping("/{id}")
    @org.springframework.security.access.prepost.PreAuthorize("hasAuthority('PERM_BRANCHES_DELETE')")
