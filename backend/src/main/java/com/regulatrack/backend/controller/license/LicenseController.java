...
@org.springframework.security.access.prepost.PreAuthorize("hasAuthority('PERM_LICENSES_VIEW')")
public class LicenseController {
    ...
    @PostMapping
    @org.springframework.security.access.prepost.PreAuthorize("hasAuthority('PERM_LICENSES_CREATE')")
    ...
    @PutMapping("/{id}")
    @org.springframework.security.access.prepost.PreAuthorize("hasAuthority('PERM_LICENSES_UPDATE')")
...
public ResponseEntity<LicenseResponse> update(
    ...
    @DeleteMapping("/{id}")
    @org.springframework.security.access.prepost.PreAuthorize("hasAuthority('PERM_LICENSES_DELETE')")
